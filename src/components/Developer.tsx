...
import type { Bone, Group, Material, SkinnedMesh } from 'three';

type AnimationName = 'idle' | 'salute' | 'clapping' | 'victory';

type DeveloperProps = ThreeElements['group'] & {
...
const Developer = ({ animationName = 'idle', ...props }: DeveloperProps) => {
  ...
  const { nodes, materials } = useGraph(clone) as unknown as DeveloperGLTF;
