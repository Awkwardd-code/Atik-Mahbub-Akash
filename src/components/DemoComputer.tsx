...
import type { Group, Material, Mesh, VideoTexture } from 'three';
import type { GLTF } from 'three-stdlib';

type DemoComputerGLTF = GLTF & {
...
const DemoComputer = ({ texture, ...rest }: DemoComputerProps) => {
  ...
  const { nodes, materials } = useGLTF('/models/computer.glb') as unknown as DemoComputerGLTF;

  const videoTexture = useVideoTexture(texture ?? '/textures/project/project1.mp4') as VideoTexture;
