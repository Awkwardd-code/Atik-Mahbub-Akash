        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className="p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/15 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105 active:scale-95 text-slate-100"
            ...
            <div className="relative group">
              <div className="relative h-80 rounded-2xl overflow-hidden border border-white/10 bg-white/5 shadow-[0_20px_60px_rgba(2,6,23,0.65)]">
                <Image
          ...
          {/* 3D Canvas */}
          <div className="sticky top-24 h-[600px] rounded-2xl overflow-hidden border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_35px_80px_rgba(15,23,42,0.65)] project-canvas">
            <Canvas>
